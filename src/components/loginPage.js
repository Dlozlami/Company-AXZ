...
export default function LoginPage()
{
    ...
    (   <div style={{width:'90vw',height:'80vh'}}>
            <div className=" w3-card-4 w3-round-large w3-white w3-display-middle" style={{padding:'20px',width:'30vw'}}>
                <h1 style={{fontWeight:'500'}} className="w3-text-green">Welcome, {userData.name}!</h1>
    ...
    const printForm =()=>
        ...
        <div style={{width:'90vw',height:'80vh'}}>
            <div className=" w3-card-4 w3-round-large w3-white w3-display-middle" style={{padding:'20px',width:'30vw'}}>
                <h1 style={{fontWeight:'500'}} className="w3-text-green">Login</h1>
                <div>
                    ...
                    <br /><br />
                    <button className="w3-btn w3-green w3-card-4 w3-round-large" onClick={(e) => dispatch(validateUser(grabInputs()))} style={{marginRight:"2vw"}}>Log in</button> <button className="w3-btn w3-green w3-card-4 w3-round-large" onClick={() => navigate('/Register')}>Register</button>
                </div>
            </div>
        </div>)
    return(<>{userData&&userData.password? printWelcome() : printForm()}
</>);
}